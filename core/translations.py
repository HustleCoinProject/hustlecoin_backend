...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "Doubles the HustleCoin (HP) you earn from tasks.": "Doubles the HustleCoin (HP) you earn from tasks.",
    ...
    "pt": {
        ...
        "Doubles the HustleCoin (HP) you earn from tasks.": "Dobra o HustleCoin (HP) que você ganha das tarefas.",
